...
urlpatterns = [
    ...
    path('cart/post', CartView.as_view(), name = 'cart_post'),
    path('cart/get', CartListView.as_view(), name = 'cart_get'),
    path('cart//update', CartUpdateView.as_view(), name = 'cart_update'),
    path('cart/delete', CartDeleteView.as_view(), name = 'cart_delete'),

    path('cartitem/post', CartItemView.as_view(), name = 'cartitem_post'),
    path("cartitem/get", CartItemListView.as_view(), name = 'cartitem_get'),
    path('cartitem/update', CartItemUpdateView.as_view(), name = 'cartitem_update'),
    path('cartitem/delete', CartItemDeleteView.as_view(), name = 'cartitem_delete'),

    path('seat/post', SeatView.as_view(), name = 'seat_post'),
    path('seat/get', SeatListView.as_view(), name = 'seat_get'),
    path('seat/update', SeatUpdateView.as_view(), name = 'seat_update'),
    path('seat/delete', SeatDeleteView.as_view(), name = 'seat_delete'),
]
